...
class ViterbiTagger:
    ...
    def run(self, sentences, normalized_sentences):
        for i, sentence in enumerate(normalized_sentences):
            ...
            # + 2 to account for start states: (*, *), and we want to run until yn+1.
            # Create table for probabilities (https://github.com/gtrght/lifelong-learning/blob/master/src/natlangp/tagger/tagger.py#L84)
